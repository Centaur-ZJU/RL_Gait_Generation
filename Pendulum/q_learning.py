...
def q_learning(env, num_episodes, Q=0, discount_factor=1.0, alpha=0.5, epsilon=0.1):
    """
    ...
    for i_episode in range(num_episodes):
        ...
        total_reward = 0
        # if i_episode == int(num_episodes * 0.9):
...
def test_Q(env, Q):
    ...
    while True:
        ...
        next_state, reward, done, _ = env.step(action)
        time.sleep(0.05)
        print('state: {}, immediate reward: {}'.format(next_state, reward))
        state = next_state
